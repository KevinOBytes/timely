...
import { Clock, FolderKanban, CalendarDays, Settings, LogOut, Bell, Users, BarChart3, CheckSquare, Receipt, Webhook, Tag, Building2 } from "lucide-react";
    ...
    <>
      ...
      <aside className="hidden md:flex fixed inset-y-0 left-0 z-50 w-64 flex-col border-r border-slate-800 bg-[#050914]">
        ...
        <div className="flex h-16 shrink-0 items-center px-6">
          <Image src="/logo.png" alt="Billabled" width={24} height={24} className="mr-2 rounded-md" unoptimized />
          <span className="text-xl font-bold tracking-tight text-white">Billabled</span>
        </div>
